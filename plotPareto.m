...
xinthin=mythin(:,1)';
yinthin=mythin(:,2)';
plot(xinthin,yinthin,'.','MarkerSize',5,'Color',[180 180 255]/255);
hold on
...
plot(x,y,'ok-','LineWidth',2,'MarkerSize',10);
...
if selectedidx>0
    plot(xin(selectedidx),yin(selectedidx),'ro','MarkerSize',10,'MarkerFaceColor','r')
end
